...
public class MCompTester {
	public static void main(String args[]) {
		...
		System.out.println("Cheapest menu item is: " + longestDescr(makeTest()).getDescription());
	}
	public static MenuItem cheapest(MComp menus){
		MenuItem min = new MenuItem("DUMMY","DUMMY",false, 1000.00);
	...
	public static MenuItem dearest(MComp menus){
		MenuItem max = new MenuItem("DUMMY","DUMMY",false, 0.00);
		for(MComp comp : menus){
	...
	public static MenuItem longestDescr(MComp menus) {
		...
		MenuItem longest = new MenuItem("", "", false, 0.00);
		for(MComp comp : menus){
			if(comp instanceof MenuItem){
				MenuItem m = (MenuItem)comp;
				if(m.getDescription().length() > longest.getDescription().length())
					longest = m;
			}
		}
		return longest;
